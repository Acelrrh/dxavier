...
sleep 2
clear
wget https://raw.githubusercontent.com/artanodrop/dxavier/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
...
sleep 2
wget https://raw.githubusercontent.com/artanodrop/dxavier/main/update/update.sh && chmod +x update.sh && ./update.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
